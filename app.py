...
def fetch_materi_sheets():
    if not API_URL_MATERI.startswith("https://script.google.com/macros/s/AKfycbwLfXYY-9-PwdVB1xQKtD1c2npawNgTeOuGHmDzPr7LGC1inbTxuxwnt8m7Z0LcJHsxyA/exec"): 
...
def save_materi_sheets(data_list):
    if API_URL_MATERI.startswith("https://script.google.com/macros/s/AKfycbwLfXYY-9-PwdVB1xQKtD1c2npawNgTeOuGHmDzPr7LGC1inbTxuxwnt8m7Z0LcJHsxyA/exec"):
        try: 
